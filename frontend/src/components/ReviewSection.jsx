...
const ReviewSection = ({ product, onReviewAdded }) => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            setComment('');
            if (onReviewAdded) onReviewAdded(); // Recargar página
        } catch (err) {
    ...
    return (
        <div className="mt-12">
            ...
            {/* Lista de Reviews */}
            {product.reviews.length === 0 && <div className="bg-blue-50 text-blue-700 p-4 rounded mb-6">No hay opiniones aún.</div>}
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-4">Escribe una opinión</h3>
                {userInfo ? (
                    ...
                    <div className="bg-yellow-50 text-yellow-800 p-4 rounded">
                        Por favor <Link href="/login" className="underline font-bold">inicia sesión</Link> para escribir una opinión.
                    </div>
                )}
            </div>
        </div>
